...
- 三套测试基线：**单测 466 / 冒烟 421 / TLS 22 全绿（另加前后端契约 30）**（跑法见 `README.md` 顶部；容量基准 `server/tests/bench.ps1` 按需跑，见 `capacity-baseline.md`）
...
| **三套测试全绿** | 单测 **466** / 冒烟 **421** / TLS **22**（2026-09-16；跑法见 `README.md`），另加前后端契约 **30** |
